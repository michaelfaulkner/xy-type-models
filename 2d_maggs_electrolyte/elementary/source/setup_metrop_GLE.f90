...
subroutine initial_measure
  ...
  write (filename, '( "temp_eq_", F4.2,"//Esum_x_samples_GLE_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' )  T, side, side, T
  open(unit = 10, file = filename)
  write (filename, '( "temp_eq_", F4.2,"//Esum_y_samples_GLE_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' )  T, side, side, T
  open(unit = 11, file = filename)
  write (filename, '( "temp_eq_", F4.2,"//charge_number_samples_GLE_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' )  T, side, side, T
  open(unit = 12, file = filename)
  write (filename, '( "temp_eq_", F4.2,"//potential_samples_GLE_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' ) &
       T, side, side, T
