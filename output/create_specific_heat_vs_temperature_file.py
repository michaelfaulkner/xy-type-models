...
def main(config_file_name):
    ...
    output_file = open(sample_directory + '/specific_heat_vs_temperature.dat', 'w')
    output_file.write("temperature".ljust(20) + '\t' + "specific heat".ljust(20) + '\t' +
                      "specific-heat error".ljust(20) + '\n')
    for i in range(no_of_temperature_increments + 1):
        beta = 1.0 / temperature
        temperature_directory = '/temp_eq_' + str(format(temperature, '.2f'))
        sample = get_sample.specific_heat(sample_directory, temperature_directory, beta, no_of_sites)[
