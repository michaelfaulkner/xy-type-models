...
output1 = open('magn_ECMC_XY_' + str('{0:0{width}}'.format(length,width=3)) + 'x'+str('{0:0{width}}'.format(length,width=3)) + '.dat','w')
output2 = open('topology_ECMC_XY_' + str('{0:0{width}}'.format(length,width=3)) + 'x'+str('{0:0{width}}'.format(length,width=3)) + '.dat','w')
...
if TwistOn == 1:
    ...
    output2.write("Temp.".ljust(5) + '\t' + "Helicity".ljust(20) + '\t' + "Hel. error".ljust(20) + '\t' + "TSF".ljust(20) + '\t' + "TSF error".ljust(20) + '\t' + "Av. sweeps".ljust(20) + '\t' + "Twist accept rate".ljust(20) + '\n')
    output3.write("Temp.".ljust(5) + '\t' + "Specific heat".ljust(20) + '\t' + "SH error".ljust(20) + '\t' + "Av. sweeps".ljust(20) + '\t' + "Twist accept rate".ljust(20) + '\n')
else:
    output1.write("Temp.".ljust(5) + '\t' + "Magnetization".ljust(20) + '\t' + "Mag. error".ljust(20) + '\t' + "Susceptibility".ljust(20) + '\t' + "Susc. error".ljust(20) + '\t' + "Av. sweeps".ljust(20) + '\n')
    output2.write("Temp.".ljust(5) + '\t' + "Helicity".ljust(20) + '\t' + "Hel. error".ljust(20) + '\t' + "TSF".ljust(20) + '\t' + "TSF error".ljust(20) + '\t' + "Av. sweeps".ljust(20) + '\n')
...
for i in range(Tsteps + 1):
    ...
    beta = 1 / temp
    Nevents = []
    input = open('temp_eq_'+str('{0:.2f}'.format(temp)) + '/Nevents_XY_' + str('{0:0{width}}'.format(length,width=3))
    ...
    if TwistOn == 1:
        ...
        + '\t' + str(susc).ljust(20) + '\t' + str(err_susc).ljust(20) + '\t' + str(AverageSweeps).ljust(20) + '\t' + str(AverageTwists).ljust(20) + '\n')
    else:
        output1.write(str(temp).ljust(5) + '\t' + str(magn).ljust(20) + '\t' + str(err_magn).ljust(20)
    ...
    f = open('temp_eq_'+str('{0:.2f}'.format(temp)) + '/autocorr_magnsq_ECMC_XY_'+str('{0:0{width}}'.format(length,width=3))
...
#    pylab.clf()
    ...
    # WRITE DATA TO FILE
    if TwistOn == 1:
        output2.write(str(temp).ljust(5) + '\t' + str(Upsilon).ljust(20) + '\t' + str(err_Upsilon).ljust(20) + '\t' + str(TSF).ljust(20) + '\t' + str(err_TSF).ljust(20) + '\t' + str(AverageSweeps).ljust(20) + '\t' + str(AverageTwists).ljust(20) + '\n')
    else:
        output2.write(str(temp).ljust(5) + '\t' + str(Upsilon).ljust(20) + '\t' + str(err_Upsilon).ljust(20) + '\t' + str(TSF).ljust(20) + '\t' + str(err_TSF).ljust(20) + '\t' + str(AverageSweeps).ljust(20) + '\n')
