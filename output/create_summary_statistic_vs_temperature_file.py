...
def check_for_config_errors(algorithm_name, observable_string):
    if (observable_string != "acceptance_rates" and observable_string != "no_of_events" and
            observable_string != "helicity_modulus" and observable_string != "magnetisation_norm" and
            ...
            observable_string != "inverse_vacuum_permittivity"):
    ...
    if ((algorithm_name == "elementary-electrolyte" or algorithm_name == "multivalued-electrolyte") and
            (observable_string == "magnetisation_norm" or observable_string == "magnetisation_phase" or
             observable_string == "helicity_modulus" or observable_string == "inverse_vacuum_permittivity")):
