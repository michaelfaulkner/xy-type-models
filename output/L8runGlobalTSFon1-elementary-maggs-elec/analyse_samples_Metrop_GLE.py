...
output1 = open('topology_Metrop_GLE_elementary' + str('{0:0{width}}'.format(length,width=3)) + 'x'+str('{0:0{width}}'.format(length,width=3)) + '.dat','w')
output2 = open('spec_heat_Metrop_GLE_elementary' + str('{0:0{width}}'.format(length,width=3)) + 'x'+str('{0:0{width}}'.format(length,width=3)) + '.dat','w')
...
for i in range(Tsteps + 1):
    ...
    InversePermSamples = 1.0 - beta * ((Esum[0] - float(MeanAndVar1[0])) ** 2 + (Esum[1] - float(MeanAndVar2[0])) ** 2) / 2 / volume
