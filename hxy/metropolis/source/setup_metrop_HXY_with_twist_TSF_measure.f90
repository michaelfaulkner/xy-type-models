...
subroutine initial_measure
  ...
  write (filename, '( "temp_eq_", F4.2,"//Ebar_w_x_via_U_samples_HXY_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' ) &
       T, side, side, T
  open(unit = 200, file = filename)
  write (filename, '( "temp_eq_", F4.2,"//Ebar_w_y_via_U_samples_HXY_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' ) &
       T, side, side, T
  open(unit = 210, file = filename)
  write (filename, '( "temp_eq_", F4.2,"//Ebar_p_x_via_U_samples_HXY_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' ) &
       T, side, side, T
  open(unit = 220, file = filename)
  write (filename, '( "temp_eq_", F4.2,"//Ebar_p_y_via_U_samples_HXY_", I3.3, "x", I3.3, "_temp", F4.2, ".dat" )' ) &
       T, side, side, T
  open(unit = 230, file = filename)
