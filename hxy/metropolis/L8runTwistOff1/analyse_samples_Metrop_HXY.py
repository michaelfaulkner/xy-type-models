...
output1 = open('magn_Metrop_HXY_' + str('{0:0{width}}'.format(length,width=3)) + 'x'+str('{0:0{width}}'.format(length,width=3)) + '.dat','w')
output2 = open('topology_Metrop_HXY_' + str('{0:0{width}}'.format(length,width=3)) + 'x'+str('{0:0{width}}'.format(length,width=3)) + '.dat','w')
output3 = open('spec_heat_Metrop_HXY_' + str('{0:0{width}}'.format(length,width=3)) + 'x'+str('{0:0{width}}'.format(length,width=3)) + '.dat','w')

if TwistOn == 1:
    output1.write("Temp.".ljust(5) + '\t' + "Magnetization".ljust(20) + '\t' + "Mag. error".ljust(20) + '\t' + "Susceptibility".ljust(20) + '\t' + "Susc. error".ljust(20) + '\t' + "Accept rate".ljust(20) + '\t' + "Twist accept rate".ljust(20) + '\n')
    output2.write("Temp.".ljust(5) + '\t' + "Helicity".ljust(20) + '\t' + "Hel. error".ljust(20) + '\t' + "TSF (CG like)".ljust(20) + '\t' + "TSF (CG like) error".ljust(20) + '\t' + "TSF (XY like)".ljust(20) + '\t' + "TSF (XY like) error".ljust(20) + '\t' + "Accept rate".ljust(20) + '\t' + "Twist accept rate".ljust(20) + '\n')
    output3.write("Temp.".ljust(5) + '\t' + "Specific heat".ljust(20) + '\t' + "SH error".ljust(20) + '\t' + "Accept rate".ljust(20) + '\t' + "Twist accept rate".ljust(20) + '\n')
else:
    ...
    output2.write("Temp.".ljust(5) + '\t' + "Helicity".ljust(20) + '\t' + "Hel. error".ljust(20) + '\t' + "TSF (CG like)".ljust(20) + '\t' + "TSF (CG like) error".ljust(20) + '\t' + "TSF (XY like)".ljust(20) + '\t' + "TSF (XY like) error".ljust(20) + '\t' + "Accept rate".ljust(20) + '\n')
    output3.write("Temp.".ljust(5) + '\t' + "Specific heat".ljust(20) + '\t' + "SH error".ljust(20) + '\t' + "Accept rate".ljust(20) + '\n')
...
for i in range(Tsteps + 1):
    ...
    input = open('temp_eq_'+str('{0:.2f}'.format(temp)) + '/acceptance_rates_HXY_' + str('{0:0{width}}'.format(length,width=3))
    ...
    f = open('temp_eq_'+str('{0:.2f}'.format(temp)) + '/autocorr_magnsq_Metrop_HXY_'+str('{0:0{width}}'.format(length,width=3))
    ...
    """
    pylab.title('Metrop XY autocorrelation' + '\n' + 'L = ' + str(length) + '; T = ' + str(temp) +
    ...
    # WRITE DATA TO FILE
    if TwistOn == 1:
        output2.write(str(temp).ljust(5) + '\t' + str(Upsilon).ljust(20) + '\t' + str(err_Upsilon).ljust(20) + '\t' + str(TSF).ljust(20) + '\t' + str(err_TSF).ljust(20) + '\t' + str(TSFTwist).ljust(20) + '\t' + str(err_TSFTwist).ljust(20) + '\t' + str(acceptanceRate).ljust(20) + '\t' + str(twistAcceptanceRate).ljust(20) + '\n')
    else:
        output2.write(str(temp).ljust(5) + '\t' + str(Upsilon).ljust(20) + '\t' + str(err_Upsilon).ljust(20) + '\t' + str(TSF).ljust(20) + '\t' + str(err_TSF).ljust(20) + '\t' + str(TSFTwist).ljust(20) + '\t' + str(err_TSFTwist).ljust(20) + '\t' + str(acceptanceRate).ljust(20) + '\n')
