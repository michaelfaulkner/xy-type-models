function get_xy_models_topological_sector_component(non_normalised_emergent_field_zero_mode_component)
use variables
implicit none
integer :: get_xy_models_topological_sector_component
...
get_xy_models_topological_sector_component = floor(non_normalised_emergent_field_zero_mode_component / two_pi / &
                                                    dfloat(integer_lattice_length) + 0.5d0 - 1.0d-8 / &
                                                    dfloat(integer_lattice_length))
end function get_xy_models_topological_sector_component
