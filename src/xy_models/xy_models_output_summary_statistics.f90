...
if (measure_helicity) then
    ...
    inverse_vacuum_perm_mean = 0.5d0 * raw_inverse_vacuum_perm_sum / dfloat(no_of_sites * no_of_observations)
    ...
    macro_josephson_current_mean(1) = raw_macro_josephson_current_sum(1) / dfloat(no_of_sites * no_of_observations)
    macro_josephson_current_mean(2) = raw_macro_josephson_current_sum(2) / dfloat(no_of_sites * no_of_observations)
    macro_josephson_current_squared_mean = raw_macro_josephson_current_squared_sum / dfloat(no_of_sites ** 2 * no_of_observations)
    macro_josephson_current_quartic_mean = raw_macro_josephson_current_quartic_sum / dfloat(no_of_sites ** 4 * no_of_observations)
...
if (measure_potential_minimising_twists) then
    potential_minimising_twists_mean(1) = potential_minimising_twists_sum(1) / dfloat(no_of_observations)
    potential_minimising_twists_mean(2) = potential_minimising_twists_sum(2) / dfloat(no_of_observations)
    potential_minimising_twists_squared_mean = potential_minimising_twists_squared_sum / dfloat(no_of_observations)
    potential_minimising_twists_quartic_mean = potential_minimising_twists_quartic_sum / dfloat(no_of_observations)
...
if (measure_twist_relaxations) then
    twist_relaxations_mean(1) = twist_relaxations_sum(1) / dfloat(no_of_observations)
    twist_relaxations_mean(2) = twist_relaxations_sum(2) / dfloat(no_of_observations)
    twist_relaxations_squared_mean = twist_relaxations_squared_sum / dfloat(no_of_observations)
    twist_relaxations_quartic_mean = twist_relaxations_quartic_sum / dfloat(no_of_observations)
...
if (measure_emergent_field) then
    zero_mode_mean(1) = sum_of_emergent_field_sum(1) / dfloat(no_of_sites * no_of_observations)
    zero_mode_mean(2) = sum_of_emergent_field_sum(2) / dfloat(no_of_sites * no_of_observations)
    zero_mode_squared_mean = sum_of_emergent_field_squared_sum / dfloat(no_of_sites ** 2 * no_of_observations)
    zero_mode_quartic_mean = sum_of_emergent_field_quartic_sum / dfloat(no_of_sites ** 4 * no_of_observations)
