...
write(6, '(A)') 'xy-type-models (version 1.0.0) - a Fortran 90/Python application for both event-chain and Metropolis &
                Monte Carlo simulaiton of the XY model, harmonic XY (HXY) model and Maggs lattice-field electrolyte &
                model (event-chain Monte Carlo (ECMC) only available for the XY and HXY models).'
