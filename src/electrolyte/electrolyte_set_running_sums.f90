...
if (measure_electric_field_sum) then
    if (start_from_checkpoint) then
        ...
        read(11, 100) raw_electric_field_zero_mode_sum(1)
        read(11, 100) raw_electric_field_zero_mode_sum(2)
        read(11, 100) raw_electric_field_zero_mode_squared_sum
        read(11, 100) raw_electric_field_zero_mode_quartic_sum
        ...
        raw_electric_field_zero_mode_sum = (/ 0, 0 /)
        raw_electric_field_zero_mode_squared_sum = 0
        raw_electric_field_zero_mode_quartic_sum = 0
