...
acceptance_rate_of_field_rotations = dfloat(no_of_accepted_field_rotations) / (no_of_observations * dfloat(no_of_sites))
acceptance_rate_of_charge_hops = dfloat(no_of_accepted_charge_hops) / (no_of_observations * dfloat(no_of_sites))
acceptance_rate_of_external_global_moves = dfloat(no_of_accepted_external_global_moves) / (no_of_observations * dfloat(no_of_sites))
